...
export class LibraryModule1786651726156 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "library_books" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "schoolId" uuid NOT NULL, "title" character varying NOT NULL, "author" character varying NOT NULL, "isbn" character varying, "category" character varying, "coverImageUrl" character varying, "isAvailable" boolean NOT NULL DEFAULT true, "description" text, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_6054209bc9f4326318a33fcda68" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "library_books" ADD CONSTRAINT "FK_a082d4c6cf755c29df969eb7085" FOREIGN KEY ("schoolId") REFERENCES "schools"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "issued_book" ADD CONSTRAINT "FK_bc37d67ca1817ee8638fb223d2c" FOREIGN KEY ("bookId") REFERENCES "library_books"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "book_request" ADD CONSTRAINT "FK_b5e76bf7c1a32e525fc09905da3" FOREIGN KEY ("bookId") REFERENCES "library_books"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "library_books" DROP CONSTRAINT "FK_a082d4c6cf755c29df969eb7085"`);
