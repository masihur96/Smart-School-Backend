...
export class RecreateOnlineClass1787850000000 implements MigrationInterface {
    name = 'RecreateOnlineClass1787850000000'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP TABLE IF EXISTS "online_class"`);
    }
}
